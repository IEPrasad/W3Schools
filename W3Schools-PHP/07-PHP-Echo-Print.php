...
PHP echo and print Statements
  ...
  ** The difference are small: echo has no return value while print has a return 
...
Display variables
  ...
  ** The following exmaple shows how to output and variables with the echo statement.
