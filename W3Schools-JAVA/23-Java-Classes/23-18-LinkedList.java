...
How the ArrayList works
  ...
  ** The ArrayList class has a regular array inside it. When an element is added, 
  ...
  is created to replace the old and the old one is removed.
...
How the LinkedList works 
  ...
  ** The LinkedList stores its items in "containers." The list has a link to the
  ...
  list. To add an element to the list, the element is placed into a new container 
...
LinkedList Methods
  ...
  ** For many cases, the ArrayList is more efficient as it is common to need 
  access to random items in the list, but the LinkedList provides several methods
  to do certain operations more efficiently:
...
addFirst() -->
  ...
  public class Main {
    public static void main(String[] args) {
      ...
      // Use the addFirst() to add the item to the beginning
      cars.addFirst("Mazda");
      System.out.println(cars);
    }
  }
