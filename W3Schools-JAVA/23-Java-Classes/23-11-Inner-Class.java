...
Private Inner Class 
  ...
  ** Unlike a "regular" class, an inner class can be private or protected. If you don't want outside objects to access the inner 
...
Example
  ...
  ** If you try to access a private inner class, an outside class, an error occurs:
