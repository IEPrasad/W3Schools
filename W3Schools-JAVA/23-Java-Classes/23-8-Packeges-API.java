...
Example 
  ...
  ** To use the Scanner class, create an object of the class and use any of the
  available method found in the Scanner class documentation. In our example, we will use the nextLine() method, which is used to read a complete line:
...
>> >>
  ...
  ** The -d keyword specifies the destination for where to save the class file.
  You can use any directory name, like c:/user (windows), or, if you want to keep 
...
---
  ...
  When we compiled the packages in the example above, a new folder was created, called "mypack". 
