...
interface which has only one method. The lambda expression should have the same 
number of parameters and the same return type as that method. Java has many of 
these kinds of interface built in, such as the Consumer interface (found in the 
java.util package) used by lists. '
