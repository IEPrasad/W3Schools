...
** Note that when you are looking with multiple parameters, the method call must 
have the same number of arguments as there are parameters, and the arguments must 
...
A Method with If...Else
  ...
  ** It is common to use if...else statements inside the methods:
