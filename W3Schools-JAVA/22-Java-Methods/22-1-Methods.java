...
Create Method
  ...
  ** A Method must be declared within a class. It is defined with the name of the method, followed by parameters (). Java provides some pre-defined methods, such 
...
** Example Explained 
  ...
  ** static means that the method belongs to the Main class and not an object 
  of the Main class. You will learn more about objects and how to access methods 
